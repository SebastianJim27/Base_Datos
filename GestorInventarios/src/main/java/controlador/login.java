...
public class login extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean authenticated = usuarioAutentico(nombre, contrasena);
    ...
    private boolean usuarioAutentico(String nombre, String contrasena) {
        Connection con = null;
        ...
        try {
            ...
            String query = "SELECT * FROM persona WHERE correo=? AND contrasena=?";
